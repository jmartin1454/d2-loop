...
# Jeff:  need to update beta_t based on this formulae
...
#########################################
# Initial conditions and geometry of loop
#########################################
...
#########################################
# end geometry and initial conditions
#########################################

# Things that we want to plot
...
def set_beam_current(curr):
    ...
    source_mod_heat=4*q_h/(D_mod*rho_0*cp)
    for i in range(0,n_mod):
        source_array[n_hex+n_down+n_right+i]=source_mod_heat
    return


# more setup and preparing to loop

Nu=4.8608 #or some constant, laminar case
hc=Nu*kt/D_hex #will also be constant
hc=300.
n_tsteps=1000000
dt=.1 # s
